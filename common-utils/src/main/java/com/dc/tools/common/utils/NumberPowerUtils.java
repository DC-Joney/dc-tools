 ...
 *
 * @apiNote change from jraft
 */
public class NumberPowerUtils {
    ...
    public static int checkedCast(final long value) {
        ...
        Assert.isTrue(result == value, "out of range: " + value);
        return result;
    }
     ...
     * @return the next positive power of 2 or this value if it is a power of 2
     */
    public static long roundToPowerOfTwo(final long value) {
